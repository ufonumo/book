...
export default function SidebarNav({ Navsidebar, showNavSidebar, showProfile }) {
  return (
    <div>
      <Nav
        className={
          Navsidebar ? 'nav-menu active col-md-12 text-center sidebar' : 'nav-menu col-md-12 text-center  sidebar'
        }
        activeKey="/home"
      >
        <div className="sidebar_sticky" onClick={showNavSidebar}>
          ...
          <Nav.Item>
            <Nav.Link href="/" className="elpis">
              {' '}
              <img src={eye} className="sidenav_icons" alt="eye" /> Elpis
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link>
              ...
              <Link to="/">
                {' '}
                <img src={compass} className="pr-3" alt="compass" /> Discover
              </Link>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="link-1">
              ...
              <Link to="/SearchClass">
                {' '}
                <img src={searchImg} className="sidenav_icons" alt="search" /> Search
              </Link>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="link-2">
              ...
              <Link to="Profile" onClick={showProfile}>
                {' '}
                <img src={profile} className="sidenav_icons" alt="profile" /> Profile
              </Link>{' '}
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link>
              ...
              <Link to="#">
                {' '}
                <img src={chat} className="sidenav_icons" alt="chat" /> Chat
              </Link>{' '}
            </Nav.Link>
          </Nav.Item>
