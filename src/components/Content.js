      ...
      <div className={booking || profile ? 'container-fluid  dark_back' : 'container-fluid  '}>
        <div className="row">
          ...
          <div className="col-lg-9" id="page-content-wrapper">
            ...
            <HomeCarousel booking={booking} profile={profile} />
            <ClassHome
            ...
            <Booking booking={booking} onClose={showBooking} showProfile={showProfile} showSuccess={showSuccess} />

            <Profile profile={profile} showProfile={showProfile} />
